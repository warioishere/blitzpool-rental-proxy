...
/// SV2 frame builders/parsers (split out for navigability).
mod codec;
use codec::*;
// The SV1 relay imports these parsers via the historical
// `crate::proto::sv2::relay::parse_*` path; preserve it after the move.
pub(crate) use codec::{
